  ...
  return (
    <div className="project-card mb-9 lg:mb-0">
      ...
      <div className='flex justify-between mt-3'>
        ...
        <Link target="_blank" href={props.githubLink || '#'} className="border border-gray-700 w-fit rounded-xl px-2 py-1 flex items-center gap-1 hover:bg-gray-300 cursor-pointer">Github Link<IoMdArrowDropright/></Link>
      </div>
    </div>
  );
};
